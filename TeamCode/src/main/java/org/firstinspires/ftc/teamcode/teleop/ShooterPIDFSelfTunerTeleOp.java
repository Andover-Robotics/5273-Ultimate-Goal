...
@Config
@TeleOp(
        name = "TELEOP Shooter Self-Tuner",
        group = "AA"
)
public final class ShooterPIDFSelfTunerTeleOp extends OpMode {
    ...
    public void stop() {
        try {
            PrintWriter writer = new PrintWriter("sdcard/FIRST/storedShooterFCoefficientTeleOp.txt");
