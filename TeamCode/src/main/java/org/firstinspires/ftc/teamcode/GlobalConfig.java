...
public final class GlobalConfig {
    ...
    public static final Pose2d RING_SHOOTING_POSITION = new Pose2d(-4 - (ROBOT_LENGTH_MM / MM_PER_INCH) / 2.0, -74 + (ROBOT_WIDTH_MM / MM_PER_INCH) / 2.0, -0.0139);
    ...
    public static final Pose2d COLLECT_OTHER_WOBBLE = new Pose2d(-45 + (ROBOT_LENGTH_MM / MM_PER_INCH) / 2.0, -34.0 + (ROBOT_WIDTH_MM / MM_PER_INCH) / 2.0, Math.toRadians(0));
