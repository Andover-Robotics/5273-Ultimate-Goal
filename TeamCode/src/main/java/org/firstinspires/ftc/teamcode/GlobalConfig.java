...
public final class GlobalConfig {
    ...
    // Servo Positions
    public final static double CARTRIDGE_INTAKE_POSITION = 0.45, CARTRIDGE_SHOOTER_POSITION = 0.10, CARTRIDGE_LEVEL_POSITION = 0.32;
    ...
    public static int AUTO_SHOOTER_RPM = 3650, HIGH_GOAL_SHOOTER_RPM = /*4100*/ 3425, POWER_SHOT_SHOOTER_RPM=3130;
    ...
    //Intaking Position
    public static final Pose2d INTAKE_POSITION= new Pose2d(-48 + (ROBOT_LENGTH_MM / MM_PER_INCH) / 2.0, -50 + (ROBOT_WIDTH_MM / MM_PER_INCH) / 2.0, Math.toRadians(-3.0));
    ...
    public static final Pose2d COLLECT_OTHER_WOBBLE_FOUR_RINGS = new Pose2d(-45 + (ROBOT_LENGTH_MM / MM_PER_INCH) / 2.0, -35.0 + (ROBOT_WIDTH_MM / MM_PER_INCH) / 2.0, Math.toRadians(0.0));
