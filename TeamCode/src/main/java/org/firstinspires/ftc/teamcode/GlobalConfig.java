...
public final class GlobalConfig {
    ...
    // Servo Positions
    public final static double CARTRIDGE_INTAKE_POSITION = 0.40, CARTRIDGE_SHOOTER_POSITION = 0.215, CARTRIDGE_LEVEL_POSITION = 0.29;
    ...
    public static final double INTAKE_MAX_POWER = 0.85, SHOOTER_MAX_POWER = 0.80, SHOOTER_LATER_RINGS_POWER = 0.78, SHOOTER_AUTO_POWER = 0.75;
    ...
    public static final Pose2d RING_SHOOTING_POSITION = new Pose2d(-12 - (ROBOT_LENGTH_MM / MM_PER_INCH) / 2.0, -73 + (ROBOT_WIDTH_MM / MM_PER_INCH) / 2.0, -0.0139);
